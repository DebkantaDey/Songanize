...
const CheckBoxKus = ({ selected, onPress, style, textStyle, size = 30, color = '#fff', text = '', ...props}) => 
{
    const [showTermsModal,setShowTermsModal] = useState(false);
    const [termsText, setTermsText] = useState('');
    const showModal = () => {
        setShowTermsModal(true);
        var textTerms = <Text style={styles.text}>INTENTION
        A genius is unique. But only 5% is inspiration, 95% is transpiration for musicians. 100% on top and you create a perfect event to wow your audience. Organize it easily with songanize.
        ...
        Administer your groups, contacts and songs
        Store “best practice”-links (e.g. songs, videos)
        Create events, send invitations and improve reach
        Share information and discover inspiration
        ...
        Use only one account with your “everyday”-name
        Save passwords and do not share your account t anyone else without permission
        Make sure that you are legal owner of any uploaded content and do not infringe copyright or intellectual property rights.
        ...
        You could quit these permissions by deleting your total account or single uploaded documents.</Text>
